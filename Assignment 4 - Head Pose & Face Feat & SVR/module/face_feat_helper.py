...
class FaceFeatHelper:
    def __init__(self, image: numpy.ndarray, image_name=''):
    ...
    def load_CJWR(self):
        ...
        # cjwr.show()
        cjwr.show('ffs/{}-cjwr.jpg'.format(self.image_name))
    ...
    def load_WHR(self):
        ...
        # whr.show()
        whr.show('ffs/{}-whr.jpg'.format(self.image_name))
    ...
    def load_PAR(self):
        ...
        # par.show()
        par.show('ffs/{}-par.jpg'.format(self.image_name))
    ...
    def load_ES(self):
        ...
        # es.show()
        es.show('ffs/{}-es.jpg'.format(self.image_name))
    ...
    def load_FWR(self):
        ...
        # fwr.show()
        fwr.show('ffs/{}-fwr.jpg'.format(self.image_name))
    ...
    def load_MEH(self):
        ...
        # meh.show()
        meh.show('ffs/{}-meh.jpg'.format(self.image_name))
    ...
    def load_CFR(self):
        ...
        # cfr.show()
        cfr.show('ffs/{}-cfr1.jpg'.format(self.image_name))
